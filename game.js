...
export class Game extends Phaser.Scene{
    ...
    create()
    {
          ...
          this.l=this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.LEFT);
          this.r=this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.RIGHT);
          ...
          this.bomb2=this.physics.add.image(2005,300,'bomb');
          this.bomb3=this.physics.add.image(2230,300,'bomb');
          this.bomb4=this.physics.add.image(2410,300,'bomb');
